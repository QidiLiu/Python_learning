...
# 原文链接：https://blog.csdn.net/Jerr__y/article/details/53218883

# 原文中代码适用于Python2，我改成了适用于Python3的形式。改了所用的print()和xrange()。
            ...
            # 否则通过行变换找到主元
                ...
                if first_row < m - 1:
                    for k in range(first_row+1, m):
                        times = float(sigma[k, main_col]) / \
                            sigma[first_row, main_col]
